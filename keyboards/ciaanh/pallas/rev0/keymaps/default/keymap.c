...
enum layers { BASE, FN, VS, CODE, TOOLS, LEFT, RIGHT };
...
#define L_LFT       MO(LEFT)
#define L_RGT       MO(RIGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LEFT] = LAYOUT_Pallas(
        ...
        _______, _______,   _COMM, _UNCOMM,  KC_DEL,            L_LFT,        _______, _______, _______,        L_RGT,          _______,          _______,                   _______  \
    ),
