...
*/
    ...
    TD(TD_CAPS),    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,    KC_H,    KC_J,    KC_K,      KC_L, KC_SCLN, KC_QUOT,  KC_ENT,            KC_END,
        ...
        KC_LCTL, KC_LGUI,    KC_LALT,  TG(_LOWER),        KC_SPC,        KC_SPC,            KC_RALT,TG(_RAISE), KC_RCTL,           KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,              XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, _______,         XXXXXXX,       XXXXXXX,              XXXXXXX, TO(_ADJUST), XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,              XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, TO(_ADJUST),       XXXXXXX,       XXXXXXX,            XXXXXXX, _______, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX
    ),

    [_ADJUST] = LAYOUT(
        QK_BOOT,  EE_CLR,  QK_RBT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,             RGB_TOG,
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, TO(_BASE),         RGB_SPD,       RGB_SPI,            XXXXXXX,TO(_BASE), XXXXXXX,     RGB_SAD, RGB_HUD, RGB_SAI
    )
};
