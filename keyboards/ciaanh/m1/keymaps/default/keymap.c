...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all( /* Base */
        ...
        KC_CAPS, KC_A,   KC_LS,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,KC_NUHS,  KC_ENT,           KC_PGDN,
        KC_LSFT, KC_NUBS, KC_Z,   KC_LX,   KC_LC,   KC_LV,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, TO_FN,   KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT),

    [_CUSTOM] = LAYOUT_all( /* Custom base */
        ...
        XXXXXXX,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,
        _______,C(KC_F6),C(KC_F7),C(KC_F8),C(KC_F9), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, _______, XXXXXXX,
        _______, _______, _______,                   _______,                            XXXXXXX,   TO_FN, XXXXXXX,          _______, _______, _______),

    [_FUNCTIONS] = LAYOUT_all( /* WASD/↑←↓→ */
        _______,   TO_BL,   TO_CL, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, _______,           RGB_TOG,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______, _______, RGB_SPI,           RGB_VAD,
        _______, _______, _______, _______, KC_CALC, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,          RGB_SPD,  RGB_HUI, _______,
